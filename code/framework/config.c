...
static struct {
	...
	{"generate_surfaces", offsetof(Config, generate_surfaces), CFT_BOOL, {0, 0}, {0, 0}, NULL, false},
	{"surface_core_count_range", offsetof(Config, surface_core_count_range), CFT_RANGE, {1, 1000}, {0, 0}, NULL, false},
	{"surface_core_size_range", offsetof(Config, surface_core_size_range), CFT_RANGE, {1, 400}, {0, 0}, NULL, false},
	{"surface_core_allow_mirror_overlap", offsetof(Config, surface_core_allow_mirror_overlap), CFT_BOOL, {0, 0}, {0, 0}, NULL, false},
	{"surface_river_height_offset", offsetof(Config, surface_river_height_offset), CFT_INT, {-8, 0}, {0, 0}, NULL, false},
	{"surface_river_ford_transform_chance", offsetof(Config, surface_river_ford_transform_chance), CFT_INT, {0, 100}, {0, 0}, NULL, false},
	{"surface_river_share", offsetof(Config, surface_river_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
	{"surface_grass_dark_share", offsetof(Config, surface_grass_dark_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
	{"surface_grass_medium_share", offsetof(Config, surface_grass_medium_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
	{"surface_grass_light_share", offsetof(Config, surface_grass_light_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
	{"surface_earth_and_stones_share", offsetof(Config, surface_earth_and_stones_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
	{"surface_earth_share", offsetof(Config, surface_earth_share), CFT_INT, {1, 100}, {0, 0}, NULL, false},
